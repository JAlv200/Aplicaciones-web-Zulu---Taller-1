...
public partial class EmployeesIndex
{
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        ...
        {
            dialog = await DialogService.ShowAsync<EmployeeCreate>("Agregar empleado", options);
        }
    ...
    private string EmployeeStatusText(bool? active)
    {
    ...
    private Color EmployeeStatusColor(bool? active)
    {
        return active switch
        {
            null => Color.Warning,
